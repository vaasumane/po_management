										...
										<div class="row p-4">
											<div class="form-group col-md-3 ">
												...
												<div class="input-group date" id="date1" data-target-input="nearest">
													<input type="text" class="form-control form-control-sm datetimepicker-input" name="from_date" id="from_date" value="<?php if (isset($from_date)) {
																																											echo $from_date;
											...
											<div class="form-group col-md-3 ">
												...
												<div class="input-group date" id="date2" data-target-input="nearest">
													<input type="text" class="form-control form-control-sm datetimepicker-input" name="to_date" id="to_date" value="<?php if (isset($to_date)) {
																																										echo $to_date;
												...
												<select class="form-control select2" name="grade_id" id="grade_id" data-placeholder="Select Grade">
													...
													<?php if (isset($grade_list)) {
														foreach ($grade_list as $list) { ?>
															<option value="<?php echo $list->grade_id; ?>" <?php if ($list->grade_status == '0') {
																												echo ' disabled';
																											} ?>><?php echo $list->grade_name; ?></option>
													<?php }
													} ?>
												</select>
											</div>
												...
												<select class="form-control select2" name="process_type_id[]" multiple id="process_type_id" data-placeholder="Select Process Type" >
													...
													<?php if (isset($process_type_list)) {
														foreach ($process_type_list as $list) { ?>
															<option value="<?php echo $list->process_type_id; ?>" <?php if ($list->process_type_status == '0') {
																														echo ' disabled';
																													} ?>><?php echo $list->process_type_name; ?></option>
													<?php }
													} ?>
												</select>
											</div>
												...
												<div class="overflow_x_auto">
													...
													<table id="exp_tbl_<?= $cnt; ?>" class="table table-bordered table-striped w-100">
														...
														<tbody>
															...
															<?php $i = 0;
															foreach ($po_report_list as $list) {
																$i++;
																...
																if ($dispatch_qty_info && $dispatch_qty_info['dispatch_qty']) {
