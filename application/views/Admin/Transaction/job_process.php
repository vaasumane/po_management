						...
						<div class="col-md-12">
										...
										<div class="row p-4">
											...
											<div class="form-group col-md-4 offset-md-2">
												...
												<div class="input-group date" id="date1" data-target-input="nearest">
													<input type="text" class="form-control form-control-sm datetimepicker-input" name="job_process_date" id="date1" value="<?php if (isset($job_process_info)) {
																																												echo $job_process_info['job_process_date'];
																																											} ?>" data-target="#date1" data-toggle="datetimepicker" required>
												</div>
											</div>
											<div class="form-group col-md-4">
												<label>VCH No.<span class="text-danger">*</span></label>
												<input type="text" class="form-control form-control-sm" name="job_process_no" id="job_process_no" value="<?php if (isset($job_process_info)) {
																																								echo $job_process_info['job_process_no'];
																																							} else {
																																								echo $job_process_no;
																																							} ?>" placeholder="Enter VCH No." readonly required>
											</div>
												...
												<select class="form-control select2" name="party_id" id="party_id" data-placeholder="Select Customer" required>
													...
													<?php if (isset($party_list)) {
														foreach ($party_list as $list) { ?>
															<option value="<?php echo $list->party_id; ?>" <?php if (isset($job_process_info) && $job_process_info['party_id'] == $list->party_id) {
																												echo 'selected';
																											}
												...
												<select class="form-control select2" name="item_id" id="item_id" data-placeholder="Select Finish Drawing No" required>
													...
													<?php if (isset($item_list)) {
														foreach ($item_list as $list) { ?>
															<option value="<?php echo $list->item_id; ?>" <?php if (isset($job_process_info) && $job_process_info['item_id'] == $list->item_id) {
																												echo 'selected';
																											}
                          ...
                          <tr>
                            ...
                            <th class="f-14 wt_50"></th>
														...
														<tbody>
															<?php if (isset($job_item_list)) {
																$i = 0;
																foreach ($job_item_list as $list) { ?>
																	...
																	<tr>
																			...
																			<div class="row">
																				...
																				<div class="form-group col-md-3 select_sm">
																					...
																					<select class="form-control select2 form-control-sm w-100 po_item_id" name="input[<?php echo $i; ?>][po_item_id]" data-placeholder="Select PO No." required>
																						...
																						<?php if (isset($po_item_list)) {
																							foreach ($po_item_list as $po_item_list2) {
																						...
																						?>
																								<option value="<?= $po_item_list2->po_item_id; ?>" <?php if ($po_item_list2->po_item_id == $list->po_item_id) {
																																						echo ' selected';
																																					}
																																					if ($po_item_list2->po_item_status == 0) {
																																						echo ' disabled';
																																					} ?>><?= $purchase_order_data['purchase_order_no']; ?></option>
																						<?php }
																						} ?>
																					</select>
																				</div>
																					...
																					<select class="form-control select2 form-control-sm w-100 grade_id" name="input[<?php echo $i; ?>][grade_id]" data-placeholder="Select Grade">
																						...
																						<?php if (isset($grade_list)) {
																							foreach ($grade_list as $grade_list2) { ?>
																								<option value="<?php echo $grade_list2->grade_id; ?>" <?php if ($grade_list2->grade_id == $list->grade_id) {
																																							echo ' selected';
																																						}
																																						if ($grade_list2->grade_status == 0) {
																																							echo ' disabled';
																																						} ?>><?php echo $grade_list2->grade_name; ?></option>
																						<?php }
																						} ?>
																					</select>
																				</div>
																				...
																				<div class="form-group col-md-3 select_sm">
																					...
																					<select class="form-control select2 form-control-sm w-100 process_type_id" name="input[<?php echo $i; ?>][process_type_id]" data-placeholder="Select Process Type" required>
																						...
																						<?php if (isset($process_type_list)) {
																							foreach ($process_type_list as $process_type_list2) { ?>
																								<option value="<?php echo $process_type_list2->process_type_id; ?>" <?php if ($process_type_list2->process_type_id == $list->process_type_id) {
																																										echo ' selected';
																																									}
																																									if ($process_type_list2->process_type_status == 0) {
																																										echo ' disabled';
																																									} ?>><?php echo $process_type_list2->process_type_name; ?></option>
																						<?php }
																						} ?>
																					</select>
																				</div>
																					...
																					<select class="form-control select2 form-control-sm w-100 department_id" name="input[<?php echo $i; ?>][department_id]" data-placeholder="Select Department" required>
																						...
																						<?php if (isset($department_list)) {
																							foreach ($department_list as $department_list2) { ?>
																								<option value="<?php echo $department_list2->department_id; ?>" <?php if ($department_list2->department_id == $list->department_id) {
																																									echo ' selected';
																																								}
																																								if ($department_list2->department_status == 0) {
																																									echo ' disabled';
																																								} ?>><?php echo $department_list2->department_name; ?></option>
																						<?php }
																						} ?>
																					</select>
																				</div>
																			...
																			<input type="text" class="form-control form-control-sm job_item_total_qty" name="input[<?php echo $i; ?>][job_item_total_qty]" value="<?= $list->job_item_total_qty; ?>" readonly required> -->
																				...
																				<div class="form-group col-md-3 select_sm">
																					...
																					<select class="form-control select2 form-control-sm w-100 ok_department_id" name="input[<?php echo $i; ?>][ok_department_id]" data-placeholder="Select Department" required>
																						...
																						<?php if (isset($department_list)) {
																							foreach ($department_list as $department_list2) { ?>
																								<option value="<?php echo $department_list2->department_id; ?>" <?php if ($department_list2->department_id == $list->ok_department_id) {
																																									echo ' selected';
																																								}
																																								if ($department_list2->department_status == 0) {
																																									echo ' disabled';
																		...
																		<div class="form-group col-md-3 select_sm">
																			...
																			<select class="form-control select2 form-control-sm w-100 rejected_department_id" name="input[<?php echo $i; ?>][rejected_department_id]" data-placeholder="Select Department" >
																				...
																				<?php if (isset($department_list)) {
																					foreach ($department_list as $department_list2) { ?>
																				<option value="<?php echo $department_list2->department_id; ?>" <?php if ($department_list2->department_id == $list->rejected_department_id) {
																																					echo ' selected';
																																				}
																																				if ($department_list2->department_status == 0) {
																																					echo ' disabled';
																			...
																			<select class="form-control select2 form-control-sm w-100 rework_department_id" name="input[<?php echo $i; ?>][rework_department_id]" data-placeholder="Select Department" >
																				...
																				<?php if (isset($department_list)) {
																					foreach ($department_list as $department_list2) { ?>
																				<option value="<?php echo $department_list2->department_id; ?>" <?php if ($department_list2->department_id == $list->rework_department_id) {
																																					echo ' selected';
																																				}
																																				if ($department_list2->department_status == 0) {
																																					echo ' disabled';
																				...
																				<!-- <div class="form-group col-md-3"></div> -->
																				<div class="form-group col-md-3 offset-md-3">
																					<input type="hidden" id="pending_qty">
																		...
																		<div class="row">
																			<div class="form-group col-md-3 select_sm">
																				...
																				<select class="form-control select2 form-control-sm w-100 po_item_id" name="input[0][po_item_id]" data-placeholder="Select PO No." required>
																					...
																					<?php if (isset($po_item_list)) {
																						foreach ($po_item_list as $po_item_list2) { ?>
																							<option value="<?php echo $po_item_list2->po_item_id; ?>" <?php if ($po_item_list2->po_item_status == 0) {
																																							echo ' disabled';
																																						} ?>><?php echo $po_item_list2->po_item_no; ?></option>
																					<?php }
																					} ?>
																				</select>
																			</div>
																			...
																			<div class="form-group col-md-3 select_sm">
																				...
																				<select class="form-control select2 form-control-sm w-100 grade_id" name="input[0][grade_id]" data-placeholder="Select Grade">
																					<option value="">Select Grade</option>
																					<?php if (isset($grade_list)) {
																						foreach ($grade_list as $grade_list2) { ?>
																							<option value="<?php echo $grade_list2->grade_id; ?>" <?php if ($grade_list2->grade_status == 0) {
																																						echo ' disabled';
																																					} ?>><?php echo $grade_list2->grade_name; ?></option>
																					<?php }
																					} ?>
																			...
																			<div class="form-group col-md-3 select_sm">
																				...
																				<select class="form-control select2 form-control-sm w-100 process_type_id" name="input[0][process_type_id]" data-placeholder="Select Process Type" required>
																					...
																					<?php if (isset($process_type_list)) {
																						foreach ($process_type_list as $process_type_list2) { ?>
																							<option value="<?php echo $process_type_list2->process_type_id; ?>" <?php if ($process_type_list2->process_type_status == 0) {
																																									echo ' disabled';
																																								} ?>><?php echo $process_type_list2->process_type_name; ?></option>
																					<?php }
																					} ?>
																			...
																			<div class="form-group col-md-3 select_sm">
																				...
																				<select class="form-control select2 form-control-sm w-100 department_id" name="input[0][department_id]" data-placeholder="Select Department" required>
																					...
																					<?php if (isset($department_list)) {
																						foreach ($department_list as $department_list2) { ?>
																							<option value="<?php echo $department_list2->department_id; ?>" <?php if ($department_list2->department_status == 0) {
																																								echo ' disabled';
																																							} ?>><?php echo $department_list2->department_name; ?></option>
																					<?php }
																					} ?>
												...
												<div class="row">
															...
															<select class="form-control select2" multiple  name="remark_id[]" id="remark_id[]" data-placeholder="Select Remark">
																...
																<?php if (isset($remark_list)) {
																	foreach ($remark_list as $list) { ?>
																		...
																		<!-- <option value="<?php echo $list->remark_id; ?>" <?php if (isset($job_process_info) && $job_process_info['remark_id'] == $list->remark_id) {
																																	echo 'selected';
																																}
																																if ($list->remark_status == '0') {
																																	echo ' disabled';
																																} ?>><?php echo $list->remark_name; ?></option> -->
																<?php }
																} ?>
													...
													<div class="col-md-12">
														<div class="form-group">
															...
															<textarea class="form-control form-control-sm " rows="4" name="job_process_note" id="job_process_note" rows="6"><?php if (isset($job_process_info)) {
																																												echo $job_process_info['job_process_note'];
																																											} ?></textarea>
														</div>
													</div>
												</div>
                          ...
                          <input class="custom-control-input" type="checkbox" name="customer_status" id="customer_status" value="0" <?php if (isset($job_process_info) && $job_process_info['customer_status'] == 0) {
																																		echo 'checked';
																																	} ?>>
									...
									<table id="example1" class="table table-bordered table-striped">
										...
										<tbody>
											<?php if (isset($job_process_list)) {
												$m = 0;
												foreach ($job_process_list as $list) {
													$m++;
													...
													<tr>
														...
														<td class="text-center">
															<div class="btn-group">
																...
																<?php }
																if ($role_id == 1 || in_array("job_process4", $role_access)) { ?>
...
<script>
	...
	$(document).on("keyup", ".job_item_ok_qty, .job_item_reject_qty, .job_item_rework_qty", function() {
		...
		if (job_item_rework_qty == '') {
			var job_item_rework_qty = 0;
		}
		...
		if (job_item_pending_qty < 0) {
			...
			$(this).closest('tr').find('.job_item_reject_qty').val('');
			$(this).closest('tr').find('.job_item_rework_qty').val('');
			$(this).closest('tr').find('.job_item_pending_qty').val(job_item_total_qty);
		} else {
