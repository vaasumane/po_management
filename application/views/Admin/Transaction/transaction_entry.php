            ...
            <div class="card <?php if(!isset($update)){ echo 'collapsed-card'; } ?> card-default">
              ...
              <div class="card-body px-0 py-0" <?php if(isset($update)){ echo 'style="display: block;"'; } else{ echo 'style="display: none;"'; } ?>>
                <form class="input_form m-0 needs-validation" novalidate id="form_action" role="form" action="" method="post" autocomplete="off" enctype="multipart/form-data">
                  <div class="row p-4">
        <input type="hidden" name="tran_type" id="tran_type" value="2">
                    ...
                    <div class="row">
                      <div class="col-md-6 text-left">
                        <!-- <div class="custom-control custom-checkbox">
                          ...
                          <label for="customer_status" class="custom-control-label">Disable This Transaction Entry</label>
                        </div> -->
                      </div>
                      <div class="col-md-6 text-right">
                        ...
                        <td class="text-center">
                          <div class="btn-group">
														...
														<?php } if($role_id == 1 || in_array("job_process4", $role_access)){ ?>  
															<a href="<?php echo base_url() ?>Transaction/delete_job_process/<?php echo $list->job_process_id; ?>" type="button" class="btn btn-sm btn-default" onclick="return confirm('Delete this Transaction Entry');"><i class="fa fa-trash text-danger"></i></a>
														<?php } ?>
...
<script>
	...
	$(document).on("keyup",".job_item_ok_qty, .job_item_reject_qty, .job_item_rework_qty", function(){
		...
		var job_item_pending_qty = job_item_total_qty - ( job_item_reject_qty );		
